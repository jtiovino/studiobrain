...
// Utility functions
export function getVoicingsForInstrument(instrument: 'guitar' | 'piano'): { [key: string]: VoicingSet } {
  return instrument === 'guitar' ? guitarVoicings : pianoVoicings;
}

export function adaptVoicingsForTuning(voicingSet: VoicingSet, tuning: string[]): VoicingSet {
...
export function filterChordsByDifficulty(chords: ChordShape[], maxDifficulty: 'beginner' | 'intermediate' | 'advanced'): ChordShape[] {
...
export function getChordsByQuality(chords: ChordShape[], quality: string): ChordShape[] {
  return chords.filter(chord => chord.quality === quality);
}

export function transposeChordShape(shape: ChordShape, semitones: number): ChordShape {
...
export function getChordShapesForRoot(voicingSet: VoicingSet, targetRoot: string): ChordShape[] {
