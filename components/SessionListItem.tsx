...
const getTabColor = (tabType: ChatSession['tabType'], lessonMode: boolean) => {
  ...
  return {
    general: lessonMode ? 'text-neon-cyan bg-neon-cyan/10' : 'text-neon-purple bg-neon-purple/10',
    mix: 'text-neon-blue bg-neon-blue/10',
    theory: lessonMode ? 'text-neon-cyan bg-neon-cyan/10' : 'text-neon-purple bg-neon-purple/10',
    instrument: lessonMode ? 'text-neon-cyan bg-neon-cyan/10' : 'text-neon-purple bg-neon-purple/10'
  }[tabType]
}
          ...
          <div className="flex-1 min-w-0">
            {isEditing ? (
              ...
              <h4 className={`font-semibold text-sm line-clamp-2 ${
                isActive 
                  ? lessonMode ? 'text-neon-cyan' : 'text-neon-purple'
                  : 'text-slate-200'
              }`}>
                {session.title}
              </h4>
